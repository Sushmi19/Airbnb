...
def datafr():
    df= pd.read_csv("K:\guvi project\prj 4 -airbnb\new\airbnb.csv")
    return df
...
if select == "Home":
    ...
    # image1= Image.open("K:\guvi project\prj 4 -airbnb\new\Airbnb.jpg")
    # st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("K:/guvi project/prj 4 -airbnb/new/airbnb.csv")
            return df_a
    ...
    with tab3:
        ...
        def datafr():
            df= pd.read_csv("K:/guvi project/prj 4 -airbnb/new/airbnb.csv")
            return df
